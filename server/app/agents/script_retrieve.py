...
- A list of pieces of information, each piece of information should be standalone and not depend on the answer of any other piece of information. Each piece of information should be a detailed explanation of the customer's needs. Return at least 3 pieces of detailed information.
NOTE:
...
async def validate_output(
    ...
    if len(output.pieces_of_information) < 3:
        raise ModelRetry("Please return at least 3 pieces of detailed information.")
    return output


@script_retrieve_agent.system_prompt
