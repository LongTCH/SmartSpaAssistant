...
interface UploadKeywordModalProps {
  open: boolean;
...
export function UploadKeywordModal({
  open,
  onOpenChange,
  selectedFile,
  onSuccess,
}: UploadKeywordModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await interestService.uploadInterestFile(selectedFile);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[90vw] max-h-screen overflow-auto">
        ...
        >
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium">Dữ liệu từ khóa</label>
